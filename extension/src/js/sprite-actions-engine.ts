...
import { IdleAction, JumpAction, SleepAction, SpriteAction, JumpRecursiveToPointInViewAction, WalkOnEdgeAction, JumpToEdgeAction, EatFoodAction, ScatterLettersAction, RandomMoveAction } from "./sprite-actions";
...
const fillAvailableActions = () => {
	...
	allActions.push(new RandomMoveAction()); // New random movement action
};
